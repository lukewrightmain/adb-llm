...
from adb_llm.transport.base import TransportLayer
...
class HealthMonitor:
    """Monitors device connectivity, rpc-server, and tunnel health."""
            ...
            for report in reports:
                if report.status == "down":
                    ...
                    logger.warning("Device {} degraded (rpc={}, tunnel={})",
                                   report.serial, report.rpc_server_running, report.tunnel_alive)
